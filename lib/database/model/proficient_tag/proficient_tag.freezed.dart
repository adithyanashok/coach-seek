...
abstract class $TagModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String userId, String text, String id});
}
...
class _$_TagModel implements _TagModel {
  const _$_TagModel(
      {required this.userId, required this.text, required this.id});
  ...
  @override
  String toString() {
    return 'TagModel(userId: $userId, text: $text, id: $id)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, userId, text, id);
...
abstract class _TagModel implements TagModel {
  const factory _TagModel(
      ...
      required final String id}) = _$_TagModel;
